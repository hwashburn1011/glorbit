...
- [ ] 24.2 dotenv loader walks up from cwd / module dir so `.env` works at repo root or in `apps/server/`
- [ ] 24.3 `scripts/bootstrap.sh` — post-clone setup (node/pnpm check, install, env copy, next-steps)
